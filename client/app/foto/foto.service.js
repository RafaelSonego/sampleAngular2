    ...
    FotoService.prototype.cadastrar = function (foto) {
        ...
        if (foto._id) {
            return this.http
                ...
                .map(function () { return new MensagemFoto('Foto alterada com sucesso', false); });
        }
        else {
            return this.http
                .post(this.url, JSON.stringify(foto), { headers: this.headers })
                .map(function () { return new MensagemFoto('Foto incluída com sucesso', true); });
        }
    };
...
var MensagemFoto = (function () {
    ...
    */
    function MensagemFoto(mensagem, inclusao) {
        this._mensagem = mensagem;
        this._inclusao = inclusao;
    }
    MensagemFoto.prototype.getMensagem = function () {
        return this._mensagem;
    };
    MensagemFoto.prototype.isInclusao = function () {
        return this._inclusao;
    };
    Object.defineProperty(MensagemFoto.prototype, "mensagem", {
    ...
    Object.defineProperty(MensagemFoto.prototype, "inclusao", {
        get: function () {
            return this._inclusao;
        },
        enumerable: true,
...
exports.MensagemFoto = MensagemFoto;
